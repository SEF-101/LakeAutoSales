      ...
      <div className="flex flex-wrap lg:flex-nowrap">
        ...
        <div className="w-full lg:w-1/2 p-4 bg-white rounded shadow-md">
          ...
          <p className="mb-4 text-black">
            ...
            and SUVs to meet the diverse needs of our customers.
          </p>
          <p className="text-black">
            Visit our dealership today and experience the exceptional service
            and quality vehicles we have to offer. We look forward to serving
            you and helping you find your dream car!
          </p>
        </div>
      </div>
