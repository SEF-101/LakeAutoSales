...
const ContactMessages = () => {
  ...
  return (
    <Card>
      <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Contact Messages</h5>
      ...
      {error ? (
        ...
        <p className="text-gray-700 dark:text-gray-400">No messages yet.</p>
      )}
    </Card>
  );
};
