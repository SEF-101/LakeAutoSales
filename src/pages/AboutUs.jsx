    ...
    return (
        <div className="flex flex-wrap lg:flex-nowrap bg-black p-6">
            ...
            <div className="w-full lg:w-1/2 p-4 bg-white rounded shadow-md">
                <h1 className="text-3xl font-bold mb-4 text-black">Welcome to Lakes Auto Sales!</h1>
                <p className="mb-4 text-black">
                    ...
                    meet the diverse needs of our customers. At our dealership, customer satisfaction is our top priority. Our knowledgeable 
                    and friendly sales team is dedicated to helping you find the perfect vehicle that suits your preferences and budget. We strive to provide
                    a hassle-free buying experience, ensuring that you feel comfortable and confident throughout the entire
                    process. In addition to our extensive inventory, we also offer comprehensive financing options to make your car-buying
                    journey seamless. Our finance experts will work closely with you to find the best loan or lease terms that fit
                    your financial situation. When it comes to servicing your vehicle, our skilled technicians are here to provide top-notch maintenance and
                    repairs. We use state-of-the-art equipment and genuine parts to ensure the longevity and performance of your
                    vehicle. Visit our dealership today and experience the exceptional service and quality vehicles we have to offer. We
